...
const ReplyIcon = ({color, width, height}) => {
    return (
        <svg viewBox="0 0 24 24" fill={color || '#6e767d'} width={width || 24} height={height || 24} aria-hidden="true" >
...
const VerifiedIcon = ({color, width, height}) => {
    return (
        <svg viewBox="0 0 24 24" fill={color || '#fff'} width={width || 19} height={height || 19} aria-hidden="true" >
